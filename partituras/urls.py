...
urlpatterns = [
    ...
    path('obras/<int:pk>/marcar-tiempo-pulso/', views.marcar_tiempo_pulso, name='marcar_tiempo_pulso'),
    path('obras/<int:pk>/pulsos-compas-actual/', views.pulsos_compas_actual, name='pulsos_compas_actual'),
